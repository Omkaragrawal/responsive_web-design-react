...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.firstname && firstname.length < 3)
            ...
            errors.firstname = 'First name shouldbe <= 15 characters';

        if (this.state.touched.lastname && lastname.length < 3)
            errors.lastname = 'Last name should be >= 3 characters';
        else if (this.state.touched.lastname && lastname.length > 20)
            errors.lastname = 'Last name shouldbe <= 20 characters';


            // copied from https://stackoverflow.com/a/44860464/8217589
        const reg = /(((^[\+,0][9][1])(((\s[0-9]{7,10})|(\S[0-9]{7,10}))|([-]\S[0-9]{7,10})))|((^[\+,0][2]{2,2})((\S[0-9]{7,8})|((([-])[0-9]{7,8})|(\s[0-9]{7,8})))))|(((^[6,7,8,9][0-9]{9,9}))|(^[0,\+](([9][1)|[6,7,8,9]))[0-9]{8,9}))/;
